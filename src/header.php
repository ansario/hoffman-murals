...
<meta name="keywords" content="Murals, Education, Residential, Business, Artwork, Personal Art, Personalized Artwork, Wall Art">
...
<body>
	<div id="width">
			<div id="navi">
				<div style="width: 900px; margin:auto; padding-left: 70px;">
					<ul>
						...
						<li id="request"><a href="quote.php">Request a Quote</a></li>
					</ul>
				</div>
			</div>
			<div id="brand">
				<div style="width: 900px; margin:auto;">
					<a href="index.php" style="text-decoration: none;"><img src="images/signature.png" style="float: right; border: none;" border="0" /></a>
				</div>
			</div>
